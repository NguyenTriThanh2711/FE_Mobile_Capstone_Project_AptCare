...
export default function TechnicianDashboard() {
  ...
  const getPriorityColor = (priorityVi) => {
    switch (priorityVi) {
      case "Khẩn cấp": return "#FF3B30";
      case "Bình thường": return "#007AFF";
  ...
  const getStatusColor = (statusVi) => {
    switch (statusVi) {
      case "Đang xử lý": return "#007AFF";
      case "Chờ xử lý": return "#FF9500";
      case "Đã xếp lịch": return "#34C759";
          ...
          <View key={job.id} style={styles.card}>
            <View style={styles.cardHeader}>
              <View style={styles.leftHeader}>
                ...
                <View style={[styles.typePill, job.type === "Inspection" ? styles.typeInspect : styles.typeRepair]}>
                  <Text style={styles.typeText}>{job.type === "Inspection" ? "Kiểm tra" : "Sửa chữa"}</Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  metaRow: { flexDirection: "row", gap: 14, alignItems: "center", marginBottom: 8, flexWrap: "wrap" },

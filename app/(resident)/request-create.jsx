...
import {
  ...
  selectRequestCreateError,
  selectRequestCreateResult,
    ...
    try {
      if (!values.shortSummary) {
        Toast.show({
          ...
          text2: 'Chọn danh mục và mô tả ngắn.',
        });
        return;
      }
      ...
      if (isEmergency === true && !values.issueId) {
        Toast.show({
          type: 'error',
          text1: 'Thiếu thông tin',
          text2: 'Khẩn cấp yêu cầu chọn Vấn đề.',
        });
        return;
      }
    ...
    <View style={styles.container}>
      ...
      {isEmergency ? (
        <LinearGradient
          ...
          <Text style={[styles.headerTitle, { color: '#fff' }]}>Tạo yêu cầu sửa chữa khẩn cấp</Text>
          <View style={{ width: 72 }} />
        </LinearGradient>
      ) : (
      ...
      {isEmergency && (
        <View style={styles.emergencyNoteWrap}>
          ...
          <Text style={styles.emergencyNoteText}>
            Chỉ chọn “Khẩn cấp” khi tình huống có nguy cơ mất an toàn (rò rỉ điện, nước tràn, cháy,
            mùi khét...). Kỹ thuật sẽ được điều phối sớm nhất có thể.
          </Text>
        </View>
      )}
      {/* Form */}
      <KeyboardAwareScrollView
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                  ...
                  <Text style={{ fontSize: 14, color: '#111827' }}>
                    Tầng {selectedApartment?.floorId}
                  </Text>
                </View>
        ...
        <Pressable
          ...
          <Text style={styles.selectText}>{currentIssueLabel}</Text>
          <Icon name="chevron.down" size={18} color="#6b7280" />
        </Pressable>
        ...
        <Modal
          ...
          transparent
          animationType="fade"
          onRequestClose={() => setOpenIssuePicker(false)}>
          <View style={styles.modalBackdrop}>
            <View style={styles.modalCard}>
              <View style={{ paddingHorizontal: 16, paddingBottom: 10 }}>
              ...
              <ScrollView style={{ paddingHorizontal: 6 }}>
                {filteredIssues.map((it) => (
                  <Pressable
                    ...
                    <Text
                      style={[
                        styles.optionText,
                        issueId === it.issueId && styles.optionTextActive,
                      ]}>
                      {it.name}
                    </Text>
                  </Pressable>
                ...
                <Pressable
                  ...
                  style={[
                    styles.optionItem,
                    issueId == null && styles.optionItemActive,
                    { marginBottom: 8 },
                  ]}>
              ...
              <View
                style={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 10, padding: 10 }}>
        ...
        {isEmergency !== true ? (
          ...
          <View style={[styles.card, styles.urgentBox]}>
            <Text style={styles.urgentText}>
              Yêu cầu khẩn cấp — điều phối kỹ thuật viên sớm nhất có thể ('Không thể chọn thời gian
              mong muốn').
            </Text>
          </View>
        )}
